...
void swap(struct node* ref1, struct node* ref2) {
    ...
    struct node* ref1Prev;
    struct node* ref1Next;
    struct node* ref2Prev;
    struct node* ref2Next;
    ...
    if(ref1->next == ref2){
        ...
        ref1Prev->next = ref1Next;
        ref1Next->prev = ref1Prev;

        ref2Prev->next = ref2Next;
        ref2Next->prev = ref2Prev;
...
struct node* concat(struct node* ref1, struct node* ref2) {
    struct node* ref2_h = begin(ref2);

    while(ref2_h != NULL){
        push_back(ref1, ref2_h->data);
        ref2_h = ref2_h->next;
...
bool includes(struct node* ref1, struct node* ref2) {
    struct node* ref1_h = begin(ref1);
    struct node* ref2_h = begin(ref2);

    while(ref1_h != NULL){
        while(ref1_h->data == ref2_h->data){
            ref1_h = ref1_h->next;
            ref2_h = ref2_h->next;
            if(ref2_h == NULL){
                return true;
